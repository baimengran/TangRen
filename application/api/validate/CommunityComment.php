...
class CommunityComment extends Validate
{
    public $rule = [
    ...
    public $message = [
        'community_id.require' => '请选择正确动态评论',
        'community_id.number' => '请选择正确动态评论',
        'community_id.communityId' => '请选择正确动态评论',
    ...
    {
        try {
            $community_ids = Db::name('community')->column('id');
