...
class RecommendComment extends Validate
{
    public $rule = [
    ...
    public $message = [
        'community_id.require' => '请选择正确内容评论',
        'community_id.number' => '请选择正确内容评论',
        'community_id.communityId' => '请选择正确内容评论',
    ...
    {
        try {
            $community_ids = Db::name('recommend')->column('id');
