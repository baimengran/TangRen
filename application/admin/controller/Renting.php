...
use app\admin\model\RentingListModel;
use think\Db;
...
class Renting extends Base
{
    public function index(){
        ...
        $count = Db::name('renting_list')->where($map)->count();//计算总页面
        $allpage = intval(ceil($count / $limits));
        $used = new RentingListModel();
        $lists = $used->getRentingByWhere($map, $Nowpage, $limits);
